    ...
    render () {
        ...
        return (
            <div className={classes.Auth}>
                {authRedirect}
                {errorMessage}
                <h2>{this.state.isSignup ? 'Register for a New Account' : 'Log In'}</h2>
                ...
                <Button 
                    ...
                    btnType="SwitchLogin">{this.state.isSignup ? 'Already have an account? SIGN-IN' : 'Need an account? SIGN-UP'}</Button>
            </div>
        );
    }
}
